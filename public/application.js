...
}, "index": function(exports, require, module) {module.exports = require('./backbone');
...
//# sourceMappingURL=underscore-min.map}, "underscore": function(exports, require, module) {//     Underscore.js 1.8.3
//     http://underscorejs.org
//     (c) 2009-2015 Jeremy Ashkenas, DocumentCloud and Investigative Reporters & Editors
//     Underscore may be freely distributed under the MIT license.
...
(function() {
  ...
  var App, Backbone, SummaryView, SymbolView, XHProf, XHProfRun, _;
...
}, "summary_view": function(exports, require, module) {(function() {
  var Backbone, SummaryView, XHProf, _;
  ...
  SummaryView = Backbone.View.extend({
    ...
    toggleSort: function(e) {
      ...
      return this.model.toggleSort(id);
    },
    render: function() {
      var cache, current_run, el;
      current_run = localStorage.getItem('xhprof:current_run');
      el = $(this.el);
      if (cache = current_run && JSON.parse(current_run)) {
        this.xhprof = new XHProf(cache.data);
        el.html(this.renderSummary(this.xhprof));
        if (el.attr("id") === "drop-area") return el.removeAttr("id");
      } else {
        el.attr("id", "drop-area");
        return el.html('Drop an XHProf file onto this space!');
      }
    },
    renderSummary: function(xhprof) {
      var buttons, buttons_template, metric, runs, runs_template, sort, summary, summary_template, total, totals, xhprof_data, xhprof_sorted, _ref,
        _this = this;
      this.xhprof = xhprof;
      xhprof_data = this.xhprof.getFlattenedData();
      totals = {};
      _ref = this.xhprof.getTotals();
      for (metric in _ref) {
        total = _ref[metric];
      ...
      xhprof_sorted = _.sortBy(xhprof_data, function(val, key, object) {
        return -val[sort];
      });
      runs_template = require("views/xhprof/runs");
      runs = runs_template({
        symbols: xhprof_sorted.slice(0, 51),
        per: function(metric, name) {
          return _this.xhprof.getPercentage(metric, name);
        }
      });
      buttons_template = require("views/xhprof/buttons");
      buttons = buttons_template({});
      return buttons + summary + runs;
    },
    resetRun: function() {
    ...
    handleFiles: function(files) {
      ...
      reader.onloadend = function(evt) {
        return _this.handleReaderLoadEnd(evt, file);
      };
    ...
    handleReaderLoadEnd: function(evt, file) {
      var cache, file_contents, namespace, run_id, xhprof_obj, _ref;
      file_contents = evt.target.result;
      _ref = file.name.split("."), run_id = _ref[0], namespace = _ref[1];
      xhprof_obj = unserialize(file_contents);
      this.xhprof = new XHProf(xhprof_obj);
      cache = {
        run_id: run_id,
        namespace: namespace,
        data: xhprof_obj
...
}, "symbol_view": function(exports, require, module) {(function() {
  var Backbone, SymbolView;
...
}, "views/xhprof/buttons": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      ...
      __out.push('<button id="reset" name="reset">Reset</button>\n');
  ...
  (function() {
    (function() {
      ...
      __out.push('<table id="xhprof-summary" cellspacing=\'0\'>\n  <tbody>\n  <tr><th colspan=2>Overall Summary</th></tr>\n  <tr>\n    <td>Total Incl. Wall Time (microsec):</td>\n    <td>');
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/xhprof/symbol_table": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      ...
      __out.push('<table>\n<tr bgcolor="#bdc7d8" align=right>\n  <th align=left><nobr><a href="/xhprof/xhprof_html/?run=1&symbol=PDOStatement%3A%3Aexecute&sort=fn&source=sum">Function Name</a></th>\n  <th class="vwbar"><nobr><a href="/xhprof/xhprof_html/?run=1&symbol=PDOStatement%3A%3Aexecute&sort=ct&source=sum">Calls</a></th>\n  <th class="vwbar"><nobr>Calls%</th>\n  <th class="vwbar"><nobr><a href="/xhprof/xhprof_html/?run=1&symbol=PDOStatement%3A%3Aexecute&sort=wt&source=sum">Incl. Wall Time<br>(microsec)</a></th>\n  <th class="vwbar"><nobr>IWall%</th>\n  <th class="vwbar"><nobr><a href="/xhprof/xhprof_html/?run=1&symbol=PDOStatement%3A%3Aexecute&sort=cpu&source=sum">Incl. CPU<br>(microsecs)</a></th>\n  <th class="vwbar"><nobr>ICpu%</th>\n  <th class="vwbar"><nobr><a href="/xhprof/xhprof_html/?run=1&symbol=PDOStatement%3A%3Aexecute&sort=mu&source=sum">Incl.<br>MemUse<br>(bytes)</a></th>\n  <th class="vwbar"><nobr>IMemUse%</th>\n  <th class="vwbar"><nobr><a href="/xhprof/xhprof_html/?run=1&symbol=PDOStatement%3A%3Aexecute&sort=pmu&source=sum">Incl.<br> PeakMemUse<br>(bytes)</a></th>\n  <th class="vwbar"><nobr>IPeakMemUse%</th>\n</tr>\n<tr bgcolor=\'#e0e0ff\'>\n  <td>Current Function</td>\n</tr>\n<tr>\n<td>\n<a href=\'\'>PDOStatement::execute</a>\n</td>\n<td class="vbar">122,846</td>\n<td class="vbar">88.0%</td>\n<td class="vbbar">1,286,883,653</td>\n<td class="vbbar">17.2%</td>\n<td class="vbar">8,092,498</td>\n<td class="vbar">0.6%</td>\n<td class="vbar">56,471,276</td>\n<td class="vbar">0.2%</td>\n<td class="vbar">45,234,932</td>\n<td class="vbar">0.1%</td>\n</tr>\n<tr bgcolor=\'#ffffff\'><td style=\'text-align:right;color:blue\'>Exclusive Metrics  for Current Function</td><td  class="vbar"></td><td  class="vbar"></td><td type=\'Child\' metric=\'wt\'  class="vbbar">1,286,883,653</td>\n<td type=\'Child\' metric=\'wt\'  class="vbbar">100.0%</td>\n<td type=\'Child\' metric=\'cpu\'  class="vbar">8,092,498</td>\n<td type=\'Child\' metric=\'cpu\'  class="vbar">100.0%</td>\n<td type=\'Child\' metric=\'mu\'  class="vbar">56,471,276</td>\n<td type=\'Child\' metric=\'mu\'  class="vbar">100.0%</td>\n<td type=\'Child\' metric=\'pmu\'  class="vbar">45,234,932</td>\n<td type=\'Child\' metric=\'pmu\'  class="vbar">100.0%</td>\n</tr><tr bgcolor=\'#e0e0ff\'><td><b><i><center>Parent function</center></i></b></td></tr><tr><td><a href="/xhprof/xhprof_html/?run=1&symbol=DatabaseStatementBase%3A%3Aexecute&sort=excl_wt&source=sum">DatabaseStatementBase::execute</a></td><td type=\'Parent\' metric=\'ct\'  class="vbar">122,846</td>\n<td type=\'Parent\' metric=\'ct\'  class="vbar">100.0%</td>\n<td type=\'Parent\' metric=\'wt\'  class="vbbar">1,286,883,653</td>\n<td type=\'Parent\' metric=\'wt\'  class="vbbar">100.0%</td>\n<td type=\'Parent\' metric=\'cpu\'  class="vbar">8,092,498</td>\n<td type=\'Parent\' metric=\'cpu\'  class="vbar">100.0%</td>\n<td type=\'Parent\' metric=\'mu\'  class="vbar">56,471,276</td>\n<td type=\'Parent\' metric=\'mu\'  class="vbar">100.0%</td>\n<td type=\'Parent\' metric=\'pmu\'  class="vbar">45,234,932</td>\n<td type=\'Parent\' metric=\'pmu\'  class="vbar">100.0%</td>\n</tr></table>\n');
  ...
  XHProf = (function() {
    ...
    XHProf.prototype.getCallCount = function() {
      var call_count, metrics, symbol, _ref;
      call_count = 0;
      _ref = this.data;
      for (symbol in _ref) {
        metrics = _ref[symbol];
    ...
    XHProf.prototype.getPercentage = function(symbol_value, metric) {
      switch (metric) {
        case "excl_wt":
          metric = "wt";
          break;
      ...
      return (100 * (symbol_value / this.overall_totals[metric])).toFixed(2);
    };

    XHProf.prototype.getFlattenedData = function() {
      if (this.flat_info == null) this.flat_info = this.computeFlatInfo();
      return this.flat_info;
    };
    ...
    XHProf.prototype.computeFlatInfo = function() {
      var info, metric, metrics, symbol, symbol_tab, _i, _j, _len, _len2;
      metrics = this.getMetrics(this.data);
      symbol_tab = this.computeInclusiveTimes(this.data);
      for (_i = 0, _len = metrics.length; _i < _len; _i++) {
        metric = metrics[_i];
        this.overall_totals[metric] = symbol_tab["main()"][metric];
      }
      ...
      return this.adjustParentChildInfo(symbol_tab, metrics);
    };

    XHProf.prototype.adjustParentChildInfo = function(symbol_tab, metrics) {
      var child, info, metric, parent, parent_child, _i, _len, _ref, _ref2;
      _ref = this.data;
...
}, "xhprof_run": function(exports, require, module) {(function() {
  var Backbone, XHProfRun;
